...
class Train:
    def __init__(self, dataset_path, img_size=(80, 80), batch_size=64, epochs=30, lr=1e-4, output_dir=None, patience=10, device='cuda'):
        ...
        self.lb = None  # This will store the LabelEncoder object
    ...
    def load_dataset(self):
        ...
        self.lb.fit(labels)
        labels = self.lb.transform(labels)  # Directly store the transformed labels
    ...
    def save_model(self):
        torch.save(self.model.state_dict(), os.path.join(self.output_dir, 'models_cnn.pth'))
