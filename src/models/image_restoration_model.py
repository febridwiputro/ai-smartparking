...
def image_restoration(stopped, base_dir, model_built_event, plate_result_queue, img_restoration_result_queue):
    img_restore = ImageRestoration(base_dir=base_dir)
...
class ImageRestoration:
    def __init__(self, base_dir=None):
        self.gan_model = GanModel(base_dir=base_dir)
